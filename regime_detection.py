"""
Program to identify and detect various market regimes
"""
...
# Open a session to use the API
rd.open_session()

# Get data for S&P500 futures contracts
...
# Define a object named RegimeDetection encapsulating functions to determine market regimes by utilising
# Agglomerative clustering, GMM, and HMM models
